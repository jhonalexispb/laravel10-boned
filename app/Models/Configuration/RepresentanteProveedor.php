...
class RepresentanteProveedor extends Model
{
    use HasFactory, SoftDeletes, LogsActivity;

    protected $table = "representante_proveedor";
    protected $fillable = [
        "name",
        "celular",
        "telefono",
    ...
    public function getActivitylogOptions(): LogOptions
    {
        ...
        return LogOptions::defaults()
            ...
            ->setDescriptionForEvent(fn(string $eventName) => "{$eventName} RepresentanteProveedor");
    }
