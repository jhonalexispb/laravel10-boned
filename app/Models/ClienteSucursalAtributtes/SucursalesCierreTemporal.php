...
class SucursalesCierreTemporal extends Model
{
    use HasFactory;
    use SoftDeletes;
    use LogsActivity;

    protected $table = "sucursales_cierre_temporal";
    ...
    public function getActivitylogOptions(): LogOptions
    {
        ...
        return LogOptions::defaults()
            ...
            ->setDescriptionForEvent(fn(string $eventName) => "{$eventName} SucursalCierreTemporal");
    }
