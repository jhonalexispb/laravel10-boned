...
class ConfigurationClienteSucursal extends Model
{
    use HasFactory;
    use SoftDeletes;
    use LogsActivity;

    protected $table = "configuration_cliente_sucursal";
    ...
    public function getActivitylogOptions(): LogOptions
    {
        ...
        return LogOptions::defaults()
            ...
            ->setDescriptionForEvent(fn(string $eventName) => "{$eventName} ConfigurationClienteSucursal");
    }
