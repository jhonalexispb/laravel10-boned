...
class Celular extends Model
{
    ...
    protected $table = "celulares_clientes";
    ...
    public function rucs()
    {
        return $this->hasManyThrough(
            ...
            CelularSucursal::class,  // Tabla intermedia (CelularSucursal)
            'celular_id',            // Clave foránea en la tabla intermedia (CelularSucursal)
