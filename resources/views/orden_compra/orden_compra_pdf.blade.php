...
<div class="web-container page-break">
    ...
    <table>
        <tbody>
            <tr>
                ...
                <td style="padding: 0 !important;border-bottom:none;">
                    N° SERIE: <strong>#00000000</strong>
                    <br>
                    <img
  ...
  <table class="invoice-info-container">
    <tr>
        <td>
          N° CONTRATO: <strong>#55555</strong>
        </td>

        <td>
          FECHA CONTRATO: 16/10/2024
        </td>
    </tr>
    ...
    <tr>
      <td class="">
        ...
        <br>
        <br>
        CLIENTE: Code Inavo Sac
        <br>
        DEPART./PROVINCIA CLIENTE: <strong>Lima/Lima/Lima</strong>
      </td>
      <td>
        DOC. 222222222222222222
      </td>
    </tr>
    <tr>
        <td>TIPO CLIENTE: CLIENTE GUBERNAMENTAL</td>
        <td>TELÉFONO: 9867786876</td>
    </tr>
    <div class="" style="display: block;width:100%;border:1px solid black;height:1px;"></div>
    <tr>
        <td>
            DIRECCIÓN: <strong>AVZ. CALLE PERU</strong>
        </td>
        <td></td>
    </tr>
    <div class="" style="display: block;width:100%;border:1px solid black;height:1px;"></div>
    <tr>
        <td>
         VENDEDOR: <strong>VICTOR MENDONZA</strong>
        </td>
        <td>
            TELÉFONO: 999999999
        </td>
  ...
  <table class="line-items-container">
    ...
    <tbody>
        <tr>
            ...
            <td class="right">100 PEN</td>
            <td class="bold">100 PEN</td>
        </tr>
    </tbody>
  </table>
    ...
    <tbody>
      <tr>
        <td class="payment-info">
            <div>
                METODO DE PAGO: <strong>TRANSFERENCIA</strong>
                <br>
                <span style="text-transform: uppercase;">INTERBANK</span>
            </div>
        </td>
        ...
        <td class="payment-info">
            ...
            <div>
              ADELANTADO: <strong>35 PEN</strong>
            </div>
            <div>
              SALDO: <strong>35 PEN</strong>
            </div>
        </td>
    </tbody>
  </table>
